...
ENV NEXT_PUBLIC_SERVER_URL=https://stream.democracyinnovators.com
...
# libsql resolves its platform binary dynamically, so Next's output tracer cannot discover it.
