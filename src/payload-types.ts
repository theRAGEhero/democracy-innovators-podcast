...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'archive-chunks': ArchiveChunksSelect<false> | ArchiveChunksSelect<true>;
...
export interface Episode {
  ...
  /**
   * Trusted legacy HTML imported from Ghost.
   */
  html?: string | null;
...
export interface Guest {
  ...
  /**
   * Concise public introduction, ideally 45-80 words.
   */
  summary?: string | null;
  /**
   * What this guest discussed in the podcast transcript.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "archive-chunks".
 */
export interface ArchiveChunk {
  ...
  /**
   * Numeric vector generated by the configured embedding model.
   */
  embedding:
    | {
        [k: string]: unknown;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'archive-chunks';
        value: number | ArchiveChunk;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "archive-chunks_select".
 */
export interface ArchiveChunksSelect<T extends boolean = true> {
  episode?: T;
  episodeTitle?: T;
  episodeSlug?: T;
  sourceType?: T;
